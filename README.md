...
**Note:**
```
This repository contains a streamlined and modularized version of the original
...
and achieving  identical results. Please note that results may differ  depending
on the model version used or due to the inherent unpredictability of responses. We
are open to discussions and clarifications.
```
## Overview
